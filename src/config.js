  ...
  rooms: {
    ...
    scripts: {
      ...
      1: [
        ...
        ['Stalactite', {sprite:  [{x: 235, y: 287}, A.StalactiteUpRowPath], amount: 3}],
      ...
      8: [
        ...
        ['Stalactite', {sprite:  [{x: 420, y: 544}, A.StalactiteUp2Path]}],
      ...
      17: [
        ...
        ['Stalactite', {sprite:  [{x: 593, y: 608}, A.StalactiteUp1Path]}],
        ['Stalactite', {sprite:  [{x: 787, y: 417}, A.StalactiteUpRowPath]}],
