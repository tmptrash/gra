  ...
  rooms: {
    ...
    scripts: {
      ...
      23: [
        ...
        ['Stalactite', {sprite:  [{x: 565, y:  32}, A.StalactiteUp1Path], amount: 2}]
      ],
      24: [
