...
export default Config = {
  ...
  rooms: {
    enemies: {
      ...
      2: [
        [[{x: 250, y: 281}, {idleLeft: [A.BugLeftPath,    2, 300], idleRight: [A.BugRightPath,    2, 300]}], .9,  true],
    ...
    scripts: {
      ...
      1: [
        ...
        ['Stalactite', {sprite:  [{x: 235, y: 287}, A.StalactiteUpRowPath], amount: 2}],
        ['Stalactite', {sprite:  [{x: 620, y:  63}, A.StalactiteUpRowPath], amount: 2}],
        //['Stalactite', {sprite:  [{x: 380, y: 287}, A.StalactiteUpRowPath]}]
      ],
      2: [
        ['Drop',       {sprite1: [{x: 537, y: 140}, A.DropPath], sprite2: [{x: 537, y: 140}, {idle: [A.DropDownPath, 12, 80]}], pos: 1, sound: 'drop2', speed: 10, delay: 2000}],
        ['Stalactite', {sprite:  [{x: 500, y:  64}, A.StalactiteUp1Path], amount: 2}],
        ['Sprite',     {sprite:  [{x: 490, y: 428}, A.Plant6Path], pos: 'end'}],
        ['Sprite',     {sprite:  [{x: 229, y: 225}, A.Plant7Path], pos: 'end'}],
        //['Stalactite', {sprite:  [{x: 130, y: 512}, A.StalactiteUp1Path], amount: 2}],
        //['Stalactite', {sprite:  [{x:  20, y:  63}, A.StalactiteUpRowPath]}]
      ],
      3: [
      ...
      8: [
        ['Drop',       {sprite1: [{x: 419, y: 115}, A.DropPath], sprite2: [{x: 419, y: 115}, {idle: [A.DropDownPath, 12, 80]}], pos: 1, before: 21, sound: 'drop2', speed: 10, delay:  500}],
        ['Drop',       {sprite1: [{x:  80, y: 109}, A.DropPath], sprite2: [{x:  80, y: 109}, {idle: [A.DropDownPath, 12, 80]}], pos: 1, sound: 'drop3', speed: 10, delay:  200}],
        ...
        ['Stalactite', {sprite:  [{x: 363, y:  63}, A.StalactiteUpRowPath]}],
        ...
        ['Stalactite', {sprite:  [{x:  38, y:  63}, A.StalactiteUpRowPath], amount: 1, pos: 'end'}]
      ],
      10: [
      ...
      16: [
        ...
        ['Portal',     {sprite:  [{x: 300, y:  60}, {idle: [A.PortalPath, 9, 80]}], pos: 1}],
        ['Water',      {params:  [31, 680, 321, 680, 7, 92], drop: [{x: 0, y:0}, {idle: [A.DropDownPath, 12, 80]}], pos: 'end' }],
        ['Stalactite', {sprite:  [{x: 312, y: 31}, A.StalactiteUp1Path], amount: 3}],
      ...
      17: [
        ...
        ['Stalactite', {sprite:  [{x: 593, y: 607}, A.StalactiteUp1Path]}],
        ['Stalactite', {sprite:  [{x: 787, y: 414}, A.StalactiteUpRowPath]}],
        ['Stalactite', {sprite:  [{x: 328, y: 705}, A.StalactiteDownRowPath], pos: 'end'}],
