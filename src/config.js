  ...
  rooms: {
    ...
    scripts: {
      ...
      1: [
        ...
        ['Stalactite', {sprite:  [{x: 241, y: 287}, A.StalactiteUpRowPath], amount: 2}],
      ...
      7: [
        ...
        ['Stalactite', {sprite:  [{x: 550, y: 288}, A.StalactiteUp2Path], amount: 2}],
        ...
        ['Stalactite', {sprite:  [{x: 131, y:  63}, A.StalactiteUp1Path]}],
