...
export default Config = {
  ...
  rooms: {
    enemies: {
      ...
      27: [
        [[{x: 500, y: 723}, {idleLeft: [A.BugBlueLeftPath,3, 200], idleRight: [A.BugBlueRightPath,3, 200]}], 3.3, true],
