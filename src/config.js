...
export default Config = {
  ...
  rooms: {
    ...
    scripts: {
      ...
      37: [
        ['Water',  {params:  [415, 712, 1023, 712, 6, 27], drop: [{x: 0, y:0}, {idle: [A.DropDownPath, 12, 40]}], after: 'hero' }]
      ],
      38: [
